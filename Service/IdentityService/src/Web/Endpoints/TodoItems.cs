...
using IdentityService.Application.TodoItems.Commands.CreateTodoItem;
using IdentityService.Application.TodoItems.Commands.DeleteTodoItem;
using IdentityService.Application.TodoItems.Commands.UpdateTodoItem;
using IdentityService.Application.TodoItems.Commands.UpdateTodoItemDetail;
using IdentityService.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace IdentityService.Web.Endpoints;
